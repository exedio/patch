...
final class PatchRun extends Item
{
	 ...
	 * @throws com.exedio.cope.StringLengthViolationException if patch, savepoint violates its length constraint.
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private PatchRun(final com.exedio.cope.ActivationParameters ap){super(ap);
}}
